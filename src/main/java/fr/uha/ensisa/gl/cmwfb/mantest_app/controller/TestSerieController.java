...
public class TestSerieController {
    ...
    public String createSerie(@RequestParam(required = true) Long testBookId,@RequestParam(required = true) String name) {
    ...
    public String addTest(@RequestParam(required = true) Long testBookId,@RequestParam(required = true) long serieId, @RequestParam(required = true) long testId){
    ...
    public String removeTest(@RequestParam(required = true) Long testBookId,@RequestParam(required = true) long serieId, @RequestParam(required = true) long testId){
    		Test test = this.daoFactory.getTestDao().find(testId);
            TestSerie testSerie = this.daoFactory.getTestSerieDao().find(serieId);
    ...
    public String addTestSerie(@RequestParam(required = true) Long testBookId,@RequestParam(required = true) long serieId, @RequestParam(required = true) long testSerieId){
    ...
    public String removeTestSerie(@RequestParam(required = true) Long testBookId,@RequestParam(required = true) long serieId, @RequestParam(required = true) long testSerieId){
    		TestSerie test = this.daoFactory.getTestSerieDao().find(testSerieId);
            TestSerie testSerie = this.daoFactory.getTestSerieDao().find(serieId);
